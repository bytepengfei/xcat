(function () {
  ...
  const messages = {
    en: {
      ...
      blockHistoryCount: "{count} recorded blocks",
      exportBlockHistory: "Export JSON",
      ...
      quickKeywordAdded: 'Added "{keyword}".',
    ...
    zh: {
      ...
      blockHistoryCount: "已记录 {count} 次拉黑",
      exportBlockHistory: "导出 JSON",
